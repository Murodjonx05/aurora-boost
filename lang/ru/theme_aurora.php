...
$string['auroranavopacity'] = 'Прозрачность панели навигации';
$string['auroranavopacitydesc'] = 'Настройте процент прозрачности фона панели навигации.';
...
$string['auroranavbarlogo'] = 'Логотип навбара';
$string['auroranavbarlogo_desc'] = 'Загрузите кастомный логотип для верхней панели. Если пусто, используется логотип сайта.';
$string['auroranavbarcustomlinks'] = 'Кастомные ссылки навбара';
$string['auroranavbarcustomlinks_desc'] = 'По одной ссылке на строку в формате: Текст|URL. Поддерживается multilang.';
$string['additionalsettings'] = 'Дополнительные настройки';
$string['linkcolor'] = 'Цвет ссылок';
$string['linkcolor_desc'] = 'Базовый цвет ссылок (a).';
$string['linkvisitedcolor'] = 'Цвет посещённых ссылок';
$string['linkvisitedcolor_desc'] = 'Цвет для посещённых ссылок (a:visited).';
$string['linkhovercolor'] = 'Цвет ссылок при наведении/фокусе';
$string['linkhovercolor_desc'] = 'Цвет для состояний a:hover и a:focus.';
$string['linkactivecolor'] = 'Цвет активной ссылки';
$string['linkactivecolor_desc'] = 'Цвет для активной ссылки (a:active).';
$string['courseblockcolorstart'] = 'Начальный цвет градиента карточек курсов';
$string['courseblockcolorstart_desc'] = 'Начальный цвет фона карточек курсов (Главная и Мои курсы).';
$string['courseblockcolorend'] = 'Конечный цвет градиента карточек курсов';
$string['courseblockcolorend_desc'] = 'Конечный цвет фона карточек курсов (Главная и Мои курсы).';
$string['footersettings'] = 'Настройки футера';
$string['footerenabled'] = 'Включить кастомный футер';
$string['footerenabled_desc'] = 'Показывать кастомный визуальный блок футера.';
$string['footerlogo'] = 'Логотип футера';
$string['footerlogo_desc'] = 'Загрузите логотип бренда для футера.';
$string['footerbrandtitle'] = 'Заголовок бренда в футере';
$string['footerbrandtitle_desc'] = 'Заголовок бренда в футере. Поддерживается multilang.';
$string['footerdescription'] = 'Описание футера';
$string['footerdescription_desc'] = 'Текст описания в футере. Поддерживается multilang.';
$string['footercontacttitle'] = 'Заголовок раздела контактов';
$string['footercontacttitle_desc'] = 'Заголовок колонки контактов. Поддерживается multilang.';
$string['footercontacttitle_default'] = 'Контакты';
$string['footercontactaddress'] = 'Адрес';
$string['footercontactaddress_desc'] = 'Строка адреса в футере. Поддерживается multilang.';
$string['footercontactphone'] = 'Телефон';
$string['footercontactphone_desc'] = 'Номер телефона в футере.';
$string['footercontactemail'] = 'Email';
$string['footercontactemail_desc'] = 'Контактный email в футере.';
$string['footercontactextra'] = 'Дополнительная строка';
$string['footercontactextra_desc'] = 'Дополнительная строка контактов. Поддерживается multilang.';
$string['footercontacts'] = 'Контакты футера (устаревшее)';
$string['footercontacts_desc'] = 'Устаревшее поле контактов списком. Используйте структурные поля выше.';
$string['footernavtitle'] = 'Заголовок раздела навигации';
$string['footernavtitle_desc'] = 'Заголовок колонки навигации. Поддерживается multilang.';
$string['footernavtitle_default'] = 'Навигация';
$string['footernavlinks'] = 'Ссылки навигации футера';
$string['footernavlinks_desc'] = 'По одной ссылке на строку в формате: Текст|URL. Поддерживается multilang.';
$string['footercopyright'] = 'Текст копирайта футера';
$string['footercopyright_desc'] = 'Текст копирайта внизу слева. Поддерживается multilang.';
$string['footerbottomright'] = 'Текст справа внизу футера';
$string['footerbottomright_desc'] = 'Текст внизу справа. Поддерживается multilang.';
